# Australia Post Tracking API For Csharp
Australia Post Tracking API and webhook make it easy to integrate Australia Post Tracking function into your own project. Support APIs Client Libraries for csharp

### API key

In order to use this API, you need to generate a Australia Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Australia Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Australia Post Tracking API](https://www.trackingmore.com/australia-post-tracking.html)  to:

   *   Get Australia Post realtime tracking info of muti-carriers in one integration
   *   Provide Australia Post shipment tracking experience like Amazon
   *   Push Australia Post notifications of package update with webhook
   *   Verify Australia Post delivery exception before it is too late
